...
class DiagnosticsManager:
    ...
    def _suite_selftest(self, mode: SelfTestMode, project_root: Path) -> dict[str, object]:
        ...
        patterns = {
            SelfTestMode.CORE: ("test_foundation.py", "test_recovery.py", "test_speech_input.py", "test_dialogue_context.py", "test_local_dialogue.py"),
            SelfTestMode.DOCUMENT: ("test_document_lifecycle.py", "test_docx_runtime.py", "test_diagnostics.py"),
            SelfTestMode.REGRESSION: ("test_foundation.py", "test_recovery.py", "test_document_lifecycle.py", "test_docx_runtime.py", "test_diagnostics.py", "test_dev4_patcher.py", "test_speech_input.py", "test_dialogue_context.py", "test_local_dialogue.py"),
        }[mode]
